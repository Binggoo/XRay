...
public:
	...
	int GetCheck();
	void  SetCheckBox(BOOL IsCheckBox = TRUE);
	...
	DWORD SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0,int nBitmapDisable = NULL, COLORREF crTransColorDisable = 0);
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0,HBITMAP hBitmapDisable = NULL, COLORREF crTransColorDisable = 0);
