...
//
DWORD CButtonST::SetIcon(int nIconIn, int nIconOut, int nIconDisable)
{
	HICON		hIconIn			= NULL;
	HICON		hIconOut		= NULL;
...
//
DWORD CButtonST::SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut, COLORREF crTransColorOut,int nBitmapDisable, COLORREF crTransColorDisable)
{
	HBITMAP		hBitmapIn		= NULL;
	HBITMAP		hBitmapOut		= NULL;
	HBITMAP     hBitmaoDisable  = NULL;
	HINSTANCE	hInstResource	= NULL;
	...
	if (nBitmapDisable)
	{
		hBitmaoDisable = (HBITMAP)::LoadImage(hInstResource, MAKEINTRESOURCE(nBitmapDisable), IMAGE_BITMAP, 0, 0, 0);
	}

	return SetBitmaps(hBitmapIn, crTransColorIn, hBitmapOut, crTransColorOut,hBitmaoDisable,crTransColorDisable);
} // End of SetBitmaps
...
//			Failed creating mask bitmap.
//
DWORD CButtonST::SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut, COLORREF crTransColorOut,HBITMAP hBitmapDisable, COLORREF crTransColorDisable)
{
	int		nRetValue;
	BITMAP	csBitmapSize;
...
void CButtonST::SetCheckBox( BOOL IsCheckBox /*= TRUE*/ )
{
