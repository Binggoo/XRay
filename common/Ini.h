...
public:		
	...
	BOOL IncreaseInt64(LPCTSTR lpSection, LPCTSTR lpKey, __int64 nIncrease = 1, int nBase = BASE_DECIMAL) const;
	...
	UINT64 GetUInt64(LPCTSTR lpSection, LPCTSTR lpKey, UINT64 nDefault, int nBase = BASE_DECIMAL) const;
	BOOL WriteUInt64(LPCTSTR lpSection, LPCTSTR lpKey, UINT64 nValue, int nBase = BASE_DECIMAL) const;
	BOOL IncreaseUInt64(LPCTSTR lpSection, LPCTSTR lpKey, UINT64 nIncrease = 1, int nBase = BASE_DECIMAL) const;
...
protected:	
	...
	static void __UInt64ToString(UINT64 nNumber, LPTSTR lpBuffer, int nBase);
